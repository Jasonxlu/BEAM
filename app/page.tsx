    ...
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-16 flex items-center justify-between">
        <Link className="flex items-center justify-center" href="#">
          ...
          <span className="ml-2 text-xl font-bold">BalanceForm</span>
        </Link>
      ...
      <footer className="border-t bg-muted">
        <div className="container px-4 md:px-6 py-8 md:py-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                Revolutionizing strength training through advanced motion sensing technology.
              </p>
            </div>
            <div className="space-y-4">
          ...
          <div className="border-t mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-xs text-muted-foreground mb-4 md:mb-0">© 2025 BalanceForm. All rights reserved.</p>
